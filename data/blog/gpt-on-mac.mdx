...
<Tweet tweetLink="chzenan/status/1631528428133584898" align="center" />
...
Open Raycast and search for "Import Extension". Select the `chatgpt-quick-actions` folder and you should be good to go.
