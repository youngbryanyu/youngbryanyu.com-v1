...
2. Search for `ChatGPT Quick Actions` using the "Store" command in Raycast. Or, you may visit [this page](https://www.raycast.com/alanzchen/chatgpt-quick-actions).
