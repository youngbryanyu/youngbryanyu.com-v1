...
To install this extension, you will need to download my extension from Github:
...
This set of commands should install the extension to Raycast. You can now invoke the extension by typing `gpt` in the Raycast search bar. After the installation, you may close the terminal window.
